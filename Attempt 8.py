...
class GeodesicShell:
    def __init__(
        ...
        self.export_edges_to_geo = self._export_edges_to_geo("lattice.geo", radius=0.001)
    ...
    def _export_edges_to_geo(self, filename="lattice.geo", radius=0.5):
        """
        ...
        with open(filename, "w") as f:
            ...
            for i, (a_idx, b_idx) in enumerate(self.edges):
                ...
                f.write(f"Cylinder({i+1}) = {{{x0},{y0},{z0},{dx},{dy},{dz},{radius}}};\n")
            f.write("Mesh 3;\n")
